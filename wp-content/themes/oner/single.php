...
<div id="content" class="site-content">  	
    ...
    <div id="primary" class="content-area <?php oner_layout_class(); ?>  columns">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php do_action('oner_after_single_content'); ?>
				...
				<section class="author-bio clearfix">
					<div class="author-info">
						...
						<div class="description">
							<h4><?php echo __( 'About Author:', 'oner' ); ?> <?php the_author_posts_link(); ?></h4>
			...
			<?php if( get_theme_mod('related_posts') && function_exists( 'oner_related_posts' ) ) : ?>
				<section class="related-posts clearfix">
					<?php oner_related_posts(); ?>
				</section>
			<?php endif;  ?>
