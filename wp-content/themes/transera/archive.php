...
get_header();
$transera_container = transera_get_container_class( 'archive-article-style' );
?>
						...
						<?php if ( have_posts() ) : ?>
							...
							<div class="slz-list-block <?php echo esc_attr( $transera_container['block_class'] ); ?>">
								...
								<?php
									...
									if ( $transera_template = transera_check_article_layout('articles', 'archive-article-style') ) {
