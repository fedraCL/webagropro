		...
		<div class="slick-item">
			...
			<div class="block-right">
				<div class="block-slide-description">
					...
					<div>
						<?php echo ( $module->get_excerpt(true, false) ); ?>
					</div>
					<?php if( $module->attributes['readmore'] == 'show' ) : ?>
						<?php echo ( $module->get_read_more( '<a href="%1$s" class="block-read-more">'. esc_html( $module->attributes['button_text'] ) .'<i class="fa fa-angle-double-right"></i></a>' ) ); ?>
					<?php endif; ?>
				</div>
			</div>
