...
$html_render = array();
$html_format = '
       <div class="item item-%7$s %8$s '.$data['classInlineBlock'].' slz-block-team-05">
           <div class="slz-block-team-05">
           %1$s
           <div class="team-content">
               <div class="team-content-wrapper">
                   <div class="sub-content">
                       <div class="team-social team-social-%7$s" data-count="%7$s">
                           %6$s
                       </div>
                   </div>
                   ...
                   %3$s
                   %5$s
                   <a href="%9$s" class="btn"><span class="btn-icon fa fa-long-arrow-right"></span><span class="btn-text">view profile</span>
                   </a>
                   </div>
               </div>
           </div>
