...
class SLZ_Icon_V2_Packs_Loader
{
	...
	public function enqueue_frontend_css()
	{
		foreach ($this->get_packs() as $pack_name => $pack) {
			 ...
			 * `slz:option-type:icon-v2:packs` filter.
			 *
			...
			if ($pack['require_css_file']) {
				...
				wp_enqueue_style(
					'slz-option-type-icon-v2-pack-' . $pack_name,
					$pack['css_file_uri'],
					array(),
	...
	private function _load_filtered_icon_packs()
	{
		...
		$packs = apply_filters(
			'slz:option_type:icon-v2:filter_packs',
	...
	public function get_default_icon_packs()
	{
		return array(
			'font-awesome' => array(
				...
				'title' => 'Font Awesome',
				'css_class_prefix' => 'fa',
				'css_file' => slz_get_framework_directory(
					'/static/libs/font-awesome/css/font-awesome.min.css'
				),

				'css_file_uri' => slz_get_framework_directory_uri(
					'/static/libs/font-awesome/css/font-awesome.min.css'
				),

				'admin_wp_enqueue_handle' => 'slz-font-awesome'
			),
			...
			'unycon' => array(
				...
				'css_file' => slz_get_framework_directory( '/static/libs/unycon/unycon.css' ),
				'css_file_uri' => slz_get_framework_directory_uri(
					'/static/libs/unycon/unycon.css'
				),

				'admin_wp_enqueue_handle' => 'slz-unycon'
			)
		);
	}
