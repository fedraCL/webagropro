...
class _SLZ_Ext_Update_Theme_Upgrader_Skin extends WP_Upgrader_Skin
{
	public function after()
	{
		$this->decrement_update_count('slz:theme');
		 ...
		 */
		$update_actions = apply_filters('slz_ext_update_theme_complete_actions', $update_actions);
