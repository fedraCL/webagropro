...
defined( 'TWITTER_API_TIMEOUT' ) || define( 'TWITTER_API_TIMEOUT', 5 );

defined( 'TWITTER_API_USERAGENT' ) || define('TWITTER_API_USERAGENT', 'PHP/'.PHP_VERSION.'; http://github.com/timwhitlock/php-twitter-api' );  

defined( 'TWITTER_API_BASE' ) || define('TWITTER_API_BASE', 'https://api.twitter.com/1.1' );

defined( 'TWITTER_OAUTH_REQUEST_TOKEN_URL' ) || define('TWITTER_OAUTH_REQUEST_TOKEN_URL', 'https://twitter.com/oauth/request_token');

defined( 'TWITTER_OAUTH_AUTHORIZE_URL' ) || define('TWITTER_OAUTH_AUTHORIZE_URL', 'https://twitter.com/oauth/authorize');

defined( 'TWITTER_OAUTH_AUTHENTICATE_URL' ) || define('TWITTER_OAUTH_AUTHENTICATE_URL', 'https://twitter.com/oauth/authenticate');

defined( 'TWITTER_OAUTH_ACCESS_TOKEN_URL' ) || define('TWITTER_OAUTH_ACCESS_TOKEN_URL', 'https://twitter.com/oauth/access_token');


if ( !class_exists('SLZ_Twitter_Client') ) :
/**
 * Client for the Twitter REST API 1.1
 */
class SLZ_Twitter_Client {
...
if ( !class_exists('TwitterOAuthToken') ) :
/**
...
if ( !class_exists('TwitterOAuthParams') ) :
/**
...
if ( !function_exists('_twitter_api_http_status_text')):
/**
...
if ( !class_exists('TwitterApiException') ) :
/**
...
if ( !class_exists('TwitterApiNotFoundException') ) :
/** 404 */
...
if ( !class_exists('TwitterApiRateLimitException') ) :
/** 429 */
