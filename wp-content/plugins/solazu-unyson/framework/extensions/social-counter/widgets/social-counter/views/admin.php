...
<div>
	...
	<br><div class="slz-widget-description"><?php echo esc_html__('Optional - a extra class for this block, if you leave it blank the block will not have a extra class', 'slz'); ?></div>
</div>
