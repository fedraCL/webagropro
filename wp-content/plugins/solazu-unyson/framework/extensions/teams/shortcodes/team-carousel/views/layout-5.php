...
$html_render = array();
$html_format = '
	<div class="item item-%7$s slz-block-team-05">
				...
				<div class="team-content-wrapper">
					...
					<div class="main-content">
						...
						<a href="%9$s" class="btn">
							...
							<span class="btn-text">'.esc_attr($data['btn_content']).'</span>
						</a>
					</div>
				</div>
			</div>
...
<div class="layout-5 sc_team_carousel slz-shortcode <?php echo esc_attr( $data['block_cls'] ); ?>" data-item="<?php echo esc_attr($data['uniq_id']); ?>">
	<?php
