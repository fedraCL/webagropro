...
class SLZ_Header_Header_05 extends SLZ_Header {
	...
	public function render( $echo = true )
	{
		...
		$options = slz_get_db_settings_option('slz-header-style-group/header_05', '');
		...
		if ( !empty ( $options ) ) {
            ...
            if ( !empty ( $menu_hv_color  ) ){
                $custom_css .= '.slz-main-menu > .slz-menu-wrapper > li > a:hover, .slz-menu-wrapper .sub-menu > li:hover > a ,.slz-menu-wrapper .mega-menu .link:hover, .slz-main-menu > .slz-menu-wrapper > li.current-menu-item > a{ color: ' . esc_attr( $menu_hv_color ) . ' }';
