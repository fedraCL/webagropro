...
$options = array(
	'general-box' => array(
	    ...
	    'options' => array(
			...
			'adspot' 	=> array(
			    'type'  => 'select',
			    'label' => esc_html__('Select Adspot', 'slz'),
			    'desc'  => esc_html__('Select adspot for ads banner.', 'slz'),
			    'choices' => array_merge( array( '' => esc_html__('-- Choose adspot --', 'slz') ), SLZ_Com::get_advertisement_list() ),
			),
	    ),
	    'show_borders' => true,
	),
