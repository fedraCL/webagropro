...
?>
<header>
	<div class="slz-header-wrapper slz-header-with-banner  <?php echo esc_attr($header_class);?>">
		<?php
		...
		<div class="slz-banner-mobile">
			<?php echo SLZ_Com::get_advertisement( slz_akg('adspot', $options, ''), 'img-bg' ); ?>
        </div>
        <!-- main menu -->
        <?php
				...
				<div class="container">
					...
					<div class="slz-header-middle-wrapper">
						...
						<div class="slz-banner-01">
							<?php echo SLZ_Com::get_advertisement( slz_akg('adspot', $options, ''), 'img-bg2' ); ?>
						</div>
					</div>
