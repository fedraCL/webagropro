...
<div class="slz-blog-detail layout-1 <?php echo esc_attr( $post_class ); ?>">
	<div class="row">
		<div class="<?php echo esc_attr( $post_col_class ); ?> slz-posts col-sm-12 slz-content-column single-posts-01">
			<?php
