...
<div class="slz-blog-detail layout-4 <?php echo esc_attr( $post_class ); ?>">
	<?php $module = new SLZ_Block_Module( get_post(), $post_instance->get_data()); ?>
	...
	?>
    <div class="row">
        <div class="<?php echo esc_attr( $post_col_class ); ?> col-sm-12 slz-posts slz-content-column single-posts-04">
            <?php
            ...
            <div class="col-md-4 col-sm-12 slz-sidebar-column slz-widgets">
                ...
                <?php 
                    ...
                    if ( slz_get_db_post_option( get_the_ID(), 'post-sidebar', '' ) != '' && slz_get_db_post_option( get_the_ID(), 'post-sidebar', '' ) != 'default' ) {
                        ...
                        $sidebar = slz_get_db_settings_option( 'blog-sidebar', 'dfdf' );
