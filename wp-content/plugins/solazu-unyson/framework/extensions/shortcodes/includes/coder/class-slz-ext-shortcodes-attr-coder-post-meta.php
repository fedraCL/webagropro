...
class SLZ_Ext_Shortcodes_Attr_Coder_Post_Meta implements SLZ_Ext_Shortcodes_Attr_Coder {
	private $meta_key = 'slz-shortcode-settings';
	private $meta_key_defaults = 'slz-shortcode-default-values';
	...
	public function encode(array $attributes, $shortcode_tag, $post_id) {
		 ...
		 * @see SLZ_Extension_Editor_Shortcodes::_action_admin_save_shortcodes
		 */
	...
	public function decode(array $attributes, $shortcode_tag, $post_id) {
		...
		$id = $attributes['slz_shortcode_id'];
	...
	public function can_decode(array $attributes, $shortcode_tag, $post_id) {
		return isset($attributes['slz_shortcode_id']); // https://github.com/ThemeFuse/Unyson/issues/469
	}
}
